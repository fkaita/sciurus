...
class ObjectTracker:
    def __init__(self):
        ...
        # カスケードファイルの読み込み
        # 例
        self._face_cascade = cv2.CascadeClassifier("/home/sciurus/Documents/data/haarcascades/haarcascade_frontalface_default.xml")
        self._eyes_cascade = cv2.CascadeClassifier("/home/sciurus/Documents/data/haarcascades/haarcascade_eye.xml")
        # self._face_cascade = ""
        # self._eyes_cascade = ""
    ...
    def detect_head_direct(self, bgr_image):

        detector = dlib.get_frontal_face_detector()
        predictor = dlib.shape_predictor( '/home/sciurus/Documents/data/shape_predictor_68_face_landmarks.dat')
